...
import iuh.fit.se.dhktpm17ctt.group5.savorgo.frontend.workforce_swing.ui.panel.form.ReservationFormUI;
...
public class FormManager {
    ...
    public static void login() {
        ...
        Drawer.setSelectedItemClass(ReservationFormUI.class);
        frame.repaint();
        frame.revalidate();
    }
