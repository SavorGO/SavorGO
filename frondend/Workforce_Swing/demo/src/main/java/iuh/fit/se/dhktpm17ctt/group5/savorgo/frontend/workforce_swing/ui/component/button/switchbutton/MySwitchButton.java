package iuh.fit.se.dhktpm17ctt.group5.savorgo.frontend.workforce_swing.ui.component.button.switchbutton;
 ...
 * @author RAVEN
 */
public class MySwitchButton extends javax.swing.JPanel {
    ...
    private SwitchButtonModel switchButtonModel;
    public MySwitchButton() {
        initComponents();
        init();
    }
    public MySwitchButton(SwitchButtonModel switchButtonModel) {
    	this.switchButtonModel = switchButtonModel;
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        lbOn.setText(switchButtonModel.getStateOn());

        lbOff.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbOff.setText(switchButtonModel.getStateOff());
        
        switchColor = switchButtonModel.getStateOnColor();
        switchOffColor = switchButtonModel.getStateOffColor();
