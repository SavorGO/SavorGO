...
import iuh.fit.se.dhktpm17ctt.group5.savorgo.frontend.workforce_swing.ui.component.LabelButton;
import iuh.fit.se.dhktpm17ctt.group5.savorgo.frontend.workforce_swing.ui.simple.SimpleInputForms2;
...
public class FormSlidePane extends Form {
    ...
    private Component createTestButton() {
        ...
        lbTest1.addOnClick(o -> {
            slidePane.addSlide(null, getTransition());
        });
