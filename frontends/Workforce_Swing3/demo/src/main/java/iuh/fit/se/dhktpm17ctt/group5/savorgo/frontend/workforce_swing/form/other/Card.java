package iuh.fit.se.dhktpm17ctt.group5.savorgo.frontend.workforce_swing.form.other;
...
public class Card extends JPanel {
    ...
    private final Consumer<Employee> event;

    public Card(Employee employee, Consumer<Employee> event) {
